...
## 5. Manual do Usuário
Após realizar as etapas de instalação e configuração a FPGA estará pronta para ser utilizada da seguinte forma (Segue imagem para servir com referência):
